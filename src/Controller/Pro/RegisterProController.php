    ...
    public function registerPro(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($existingUser instanceof User) {
                if (!$existingUser->isVerified()) {
                    $emailVerifier->sendEmailConfirmation(
                        ...
                        (new TemplatedEmail())
                            ...
                            ->subject('Validez votre adresse email professionnelle')
                ...
                $this->addFlash('success', 'Votre espace professionnel a bien été créé. Vérifiez maintenant votre email pour l’activer.');

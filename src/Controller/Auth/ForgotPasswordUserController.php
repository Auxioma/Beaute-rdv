...
final class ForgotPasswordUserController extends AbstractController
{
    ...
    public function forgotPasswordUser(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, string $locale, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $mailer->send(
            (new TemplatedEmail())
                ...
                ->subject($translator->trans('auth.email.reset.subject'))

...
namespace App\Entity\Establishment;
...
use App\Entity\Booking\Appointment;#[ORM\Entity(repositoryClass: EstablishmentRepository::class)]#[ORM\Table(name: 'establishment')]#[ORM\Index(name: 'IDX_ESTABLISHMENT_STATUS', fields: ['status'])]#[ORM\Index(name: 'IDX_ESTABLISHMENT_COUNTRY_ACTIVITY', fields: ['countryCode', 'activityType'])]

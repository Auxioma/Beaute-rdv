...
use App\Repository\Establishment\EstablishmentOpeningHourRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: EstablishmentOpeningHourRepository::class)]#[ORM\Table(name: 'establishment_opening_hour')]

...
use App\Repository\Auth\UserSecurityTokenRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: UserSecurityTokenRepository::class)]#[ORM\Table(name: 'user_security_token')]

...
use App\Repository\Setting\BookingWidgetRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: BookingWidgetRepository::class)]#[ORM\Table(name: 'booking_widget')]#[ORM\HasLifecycleCallbacks]
class BookingWidget
{
    use CreatedAtTraits;
    use UpdatedAtTraits;

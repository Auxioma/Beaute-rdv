...
use App\Entity\Booking\Appointment;#[ORM\Entity(repositoryClass: ReviewRepository::class)]#[ORM\Table(name: 'review')]#[ORM\Index(name: 'IDX_REVIEW_STATUS', fields: ['status'])]#[ORM\HasLifecycleCallbacks]
class Review
{
    use CreatedAtTraits;
    use UpdatedAtTraits;

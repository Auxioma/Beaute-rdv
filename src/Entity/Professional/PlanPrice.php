...
use App\Repository\Professional\PlanPriceRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: PlanPriceRepository::class)]#[ORM\HasLifecycleCallbacks]
class PlanPrice
{
    #[ORM\Id]
    #[ORM\GeneratedValue]

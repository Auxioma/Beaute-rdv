...
use App\Repository\Professional\SubscriptionPlanPriceRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: SubscriptionPlanPriceRepository::class)]#[ORM\Table(name: 'subscription_plan_price')]

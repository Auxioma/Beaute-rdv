...
use App\Repository\Professional\SubscriptionInvoiceRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: SubscriptionInvoiceRepository::class)]#[ORM\Table(name: 'subscription_invoice')]

...
use App\Repository\Professional\WebhookEventRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: WebhookEventRepository::class)]#[ORM\Table(name: 'webhook_event')]

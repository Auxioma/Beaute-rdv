...
use App\Repository\Professional\SubscriptionPaymentRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: SubscriptionPaymentRepository::class)]#[ORM\Table(name: 'subscription_payment')]

...
use App\Repository\Professional\ProfessionalAccountRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;

use App\Entity\Auth\User;#[ORM\Entity(repositoryClass: ProfessionalAccountRepository::class)]#[ORM\Table(name: 'professional_account')]#[ORM\HasLifecycleCallbacks]class ProfessionalAccount
{
    use CreatedAtTraits;
    use UpdatedAtTraits;
    use DeletedAtTraits;

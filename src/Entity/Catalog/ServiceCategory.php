...
use App\Repository\Catalog\ServiceCategoryRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: ServiceCategoryRepository::class)]#[ORM\Table(name: 'service_category')]#[ORM\UniqueConstraint(name: 'UNIQ_SRV_CATEGORY_EST_SLUG', fields: ['establishment', 'slug'])]

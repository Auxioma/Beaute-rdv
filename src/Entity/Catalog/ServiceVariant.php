...
use App\Repository\Catalog\ServiceVariantRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: ServiceVariantRepository::class)]#[ORM\Table(name: 'service_variant')]

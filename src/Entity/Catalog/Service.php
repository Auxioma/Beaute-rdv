...
use App\Repository\Catalog\ServiceRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: ServiceRepository::class)]#[ORM\Table(name: 'service')]#[ORM\HasLifecycleCallbacks]
class Service
{
    use CreatedAtTraits;
    use UpdatedAtTraits;

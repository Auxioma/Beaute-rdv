...
use App\Repository\Booking\BookingRuleRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: BookingRuleRepository::class)]#[ORM\Table(name: 'booking_rule')]#[ORM\UniqueConstraint(name: 'UNIQ_BOOKING_RULE_ESTABLISHMENT', fields: ['establishment'])]

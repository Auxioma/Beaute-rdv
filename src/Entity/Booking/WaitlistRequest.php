...
use App\Repository\Booking\WaitlistRequestRepository;
...
use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: WaitlistRequestRepository::class)]#[ORM\Table(name: 'waitlist_request')]#[ORM\HasLifecycleCallbacks]class WaitlistRequest
{
    use CreatedAtTraits;
    use UpdatedAtTraits;
    #[ORM\Id]

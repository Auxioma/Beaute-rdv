...
use App\Repository\Booking\AppointmentRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\EstablishmentMember;

use App\Entity\Auth\User;
use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: AppointmentRepository::class)]#[ORM\Table(name: 'appointment')]#[ORM\Index(name: 'IDX_APPOINTMENT_STATUS', fields: ['status'])]#[ORM\Index(name: 'IDX_APPOINTMENT_STARTS_AT', fields: ['startsAt'])]

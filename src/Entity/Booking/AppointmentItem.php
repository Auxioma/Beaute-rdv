...
use App\Repository\Booking\AppointmentItemRepository;
...
use App\Entity\Establishment\PhysicalResource;#[ORM\Entity(repositoryClass: AppointmentItemRepository::class)]#[ORM\Table(name: 'appointment_item')]#[ORM\HasLifecycleCallbacks]class AppointmentItem
{
    use CreatedAtTraits;
    use UpdatedAtTraits;
    #[ORM\Id]

...
use App\Repository\Client\ClientProfileRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Auth\User;#[ORM\Entity(repositoryClass: ClientProfileRepository::class)]#[ORM\Table(name: 'client_profile')]#[ORM\HasLifecycleCallbacks]
class ClientProfile
{
    use CreatedAtTraits;
    use UpdatedAtTraits;

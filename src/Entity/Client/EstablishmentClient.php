...
use App\Repository\Client\EstablishmentClientRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;

use App\Entity\Auth\User;#[ORM\Entity(repositoryClass: EstablishmentClientRepository::class)]#[ORM\Table(name: 'establishment_client')]#[ORM\HasLifecycleCallbacks]class EstablishmentClient
{
    use CreatedAtTraits;
    use UpdatedAtTraits;
    #[ORM\Id]

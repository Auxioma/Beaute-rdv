...
use App\Entity\Booking\Appointment;#[ORM\Entity(repositoryClass: NotificationLogRepository::class)]#[ORM\Table(name: 'notification_log')]#[ORM\HasLifecycleCallbacks]class NotificationLog
{
    use CreatedAtTraits;
    use UpdatedAtTraits;
    #[ORM\Id]

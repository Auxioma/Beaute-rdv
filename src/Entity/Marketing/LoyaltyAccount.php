...
use App\Repository\Marketing\LoyaltyAccountRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Auth\User;#[ORM\Entity(repositoryClass: LoyaltyAccountRepository::class)]#[ORM\Table(name: 'loyalty_account')]#[ORM\UniqueConstraint(name: 'UNIQ_LOYALTY_ACCOUNT_CLIENT_PROGRAM', fields: ['client', 'loyaltyProgram'])]

...
use App\Repository\Marketing\PromoCodeRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Establishment\Establishment;#[ORM\Entity(repositoryClass: PromoCodeRepository::class)]#[ORM\Table(name: 'promo_code')]#[ORM\HasLifecycleCallbacks]
class PromoCode
{
    use CreatedAtTraits;
    use UpdatedAtTraits;

...
use App\Repository\Content\SeoPageRepository;
use Doctrine\ORM\Mapping as ORM;#[ORM\Entity(repositoryClass: SeoPageRepository::class)]#[ORM\Table(name: 'seo_page')]

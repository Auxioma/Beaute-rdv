...
use App\Repository\Content\BlogPostRepository;
use Doctrine\ORM\Mapping as ORM;

use App\Entity\Catalog\Category;#[ORM\Entity(repositoryClass: BlogPostRepository::class)]#[ORM\Table(name: 'blog_post')]#[ORM\UniqueConstraint(name: 'UNIQ_BLOG_POST_LOCALE_SLUG', fields: ['locale', 'slug'])]
